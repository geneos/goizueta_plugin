...
public class CurrentAccountQueryLot {
	...
	public CurrentAccountQueryLot(Properties ctx, Integer orgID,
	 ...
	 *         fechas
	 */
	public String getAllDocumentsQuery(int lot) {
		...
		if (detailReceiptsPayments) {
			...
			if(lot != 0){
				sqlDoc.append("   AND d.C_Bpartner_ID IN (SELECT C_Bpartner_ID FROM libertya.C_Bpartner where C_BP_Group_ID = " + lot + ") ");
			}
	 ...
	 */
	public String getQuery(int lot) {
		String sqlDoc = getAllDocumentsQuery(lot);
	 ...
	 */
	public String getAcumBalanceQuery(int lot) {
		String sqlDoc = getAllDocumentsQuery(lot);
	 ...
	 */
	public String getBalanceQuery(int lot) {
		String sql = getAllDocumentsQuery(lot);
		StringBuffer sqlBalance = new StringBuffer();
		sqlBalance
