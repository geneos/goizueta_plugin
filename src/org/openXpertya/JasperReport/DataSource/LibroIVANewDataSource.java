	...
	private String getQuery() {
		StringBuffer query = new StringBuffer(
				"     SELECT "
						...
						+ "				 AND (c_invoice.docstatus = 'CO'::bpchar OR c_invoice.docstatus = 'CL'::bpchar OR c_invoice.docstatus = 'RE'::bpchar OR c_invoice.docstatus = '??'::bpchar) AND c_invoice.isactive = 'Y'::bpchar "
