...
def main():
	...
	try:
		...
		try:
		   open("error.txt","w").write("Error help.FECAESolicitar: Esta conectado a internet?")
		except:
		   sys.exit("Error help.FECAESolicitar: Esta conectado a internet?\n")
        	sys.exit("Error help.FECAESolicitar: Esta conectado a internet?\n")	
	...
	try:
		...
		try:
		   open("error.txt","w").write("Error obtener ultimo comprobante: Esta conectado a internet?")
		except:
		#Error de coneccion
		   sys.exit(2)
        	sys.exit(2)
...
#        wsfev1.AgregarTributo(id, desc, base_imp, alic, importe)
	...
	try:
		...
		try:
		   open("error.txt","w").write("Error registrar comprobante: Esta conectado a internet?")
		except:
		#Error de coneccion/respuesta en este caso la factura queda y se debe gestionar a mano
		   sys.exit(3)
        	sys.exit(3)
