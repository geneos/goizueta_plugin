...
ALTER TABLE C_Invoice ALTER COLUMN cg_sender_details TYPE character varying(150);
ALTER TABLE C_Invoice ALTER COLUMN cg_aditional_per_value TYPE numeric(10,2);
